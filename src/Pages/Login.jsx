...
export const Login = (props) => {
  ...
  // switch (selectedPage) {
  //   case "UserCover":
  //     SelectedComponent = LoginUserCover;
  //   case "OTP":
  //     SelectedComponent = LoginOTP;
  //   case "WP":
  //     SelectedComponent = LoginWP;
  //   default:
  //     SelectedComponent = LoginUserCover;
  // }
                      ...
                      <div className="p-lg-5 p-4">
                        <div>
                          ...
                          <p className="text-muted">
                            Welcome! Sign in with email to access Suncity.
                          </p>
                        </div>
                          ...
                          >
                            ...
                            <div className="mb-4">
                              <p className="mb-0 fs-12 text-muted fst-italic">
                                By login you agree to the suncity &nbsp;
                                <span
          ...
          <Row>
            <Col lg={12}>
              <div className="text-center">
                <p className="mb-3">&copy; 2024 | Suncity Pvt. Ltd.</p>
              </div>
            </Col>
          </Row>
        </Container>
